...
$_LANG['edit_password_failure'] = '您输入的密码不一致！';
$_LANG['edit_password_success'] = '您的新密码已设置成功！';
$_LANG['edit_yzm_failure'] = '您输入的验证码不正确！';
...
$_LANG['msg_un_registered'] = '手机号已经存在,请重新输入';
...
$_LANG['register_success'] = '用户名 %s 注册成功,你的初始密码为【123456】';
...
$_LANG['passport_js']['username_shorter'] = '- 手机长度不能少于11 个字符。';
...
$_LANG['passport_js']['msg_un_registered'] = '* 手机号已经存在,请重新输入';
