...
class wxPayHelper extends Common_util_pub
{
	...
	protected function get_cft_package(){
		try {
			...
			return $paraString . "&sign=" . $this->sign($unSignParaString,$this->trimString(WXKEY));
		}catch (SDKRuntimeException $e)
		{
			die($e->errorMessage());
		}
	...
	*/
	function create_biz_package(){
		 try {
		    ...
		    $nativeObj["appId"] = WXAPPID;
		    $nativeObj["package"] = $this->get_cft_package();
			$timeStamp = time();
		    $nativeObj["timeStamp"] = (string)$timeStamp;
		    $nativeObj["nonceStr"] = $this->createNoncestr();
