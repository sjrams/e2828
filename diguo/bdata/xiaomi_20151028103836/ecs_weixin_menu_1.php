...
E_D("replace into `ecs_weixin_menu` values('39','会员功能','1','','member','http://xm.58ecshop.co','2','0','0');");
...
E_D("replace into `ecs_weixin_menu` values('49','微商城','1','','index','http://shop.hejin.com/xiaomi2014','50','1','40');");
