...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ecshop小米2015旗舰版-慧通网络','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ecshop小米2015旗舰版-慧通网络','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ecshop小米2015旗舰版-慧通网络','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ecshop小米2015旗舰版-慧通网络','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','慧通网络http://www.htwl168.com/','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','400-800-8888','1');");
...
E_D("replace into `ecs_shop_config` values('207','2','use_storage','select','1,0','','0','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1452153832','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','fc6fe38c8ea72f430678599e05d0a98b4ac4ec0cc00f80f4c64ccf26586aa144','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','小米手机3,小米电视','0');");
...
E_D("replace into `ecs_shop_config` values('801','8','sms_shop_mobile','text','','','13818058552','1');");
