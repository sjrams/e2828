<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:53:"D:/xampp/htdocs/e2828/mobile/themes/default/goods.dwt";i:1;s:67:"D:/xampp/htdocs/e2828/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1471426819;s:8:"maketime";i:1471423219;}<!DOCTYPE html>
...
<title>华硕ZenFone 飞马3 x008（高配版/全网通）_华硕_手机专区_汕头E家数码-汕头手机报价网|汕头手机网|汕头手机门户网站 - Powered by ECShop触屏版</title>
...
<div class="header_03">
  ...
  <div style="" class="tit">
    <h3>华硕ZenFone 飞马3 x008（高配版/全网通）</h3>
  </div>
  <div class="nav">
    <ul>
...
function chgNum(a) {
    ...
    if (a == 1) {
      ...
      <div class="show">
        ...
        <div class="flexslider">
          <ul class="slides">
            ...
            <li ><img src="../images/201607/goods_img/388_P_1467935730700.jpg" /></li>
             
            <li style="display:none"><img src="../images/201607/goods_img/388_P_1467935731244.jpg" /></li>
             
            <li style="display:none"><img src="../images/201607/goods_img/388_P_1467935731591.jpg" /></li>
                      </ul>
        </div>
      </div>
      ...
      <div class="pro-info">
        <p class="pro-name"><strong>华硕ZenFone 飞马3 x008（高配版/全网通）</strong></br>
          </p>
        <div class="price clearfix">
          <p class="jx-price">售价&nbsp;&nbsp;&nbsp;<strong>￥1480.00</strong></p>
          <p class="market-price"><strong>￥1628.00</strong></p>
        </div>
        ...
        <form action="javascript:addToCart(388)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          ...
          <p class="name">规格</p>
          <div class="catt">
						<a class="cattsel" onclick="changeAtt(this,1861,388)"
			href="javascript:;" name="1861">行货<input style="display:none"
			id="spec_value_1861" type="radio" name="spec_8" value="1861" 			checked /></a>
						</div>
		</div>
          ...
          <div class='goods_number clearfix'>
            <p class="detial clearfix">购买可使用：<font class="red">74000 积分</font></p>
          </div>
      ...
      <div class="pro-detial">
        <div class="judge clearfix"> <a href="goods.php?act=view_comment&id=388"><span class="m-ratescore"><i style="WIDTH: 100%">100%</i></span> <span class="all"><strong>554fcae493e564ee0dc75bdf2ebf94cagoods_comment|a:2:{s:4:"name";s:13:"goods_comment";s:2:"id";s:3:"388";}554fcae493e564ee0dc75bdf2ebf94ca</strong>人评论</span> <span class="nice"><strong>100%</strong>好评</span></a> <span class="arrow"></span> </div>
        <div class="pro-intro clearfix"> <a href="goods.php?act=view_img&id=388"><span>商品详细介绍</span></a> <span class="arrow"></span> </div>
      </div>
...
<script language="javascript">
$('#pc_nav').attr('href', './../goods.php?id=388');
</script>
</body>
</html>
