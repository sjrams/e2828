<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:53:"D:/xampp/htdocs/e2828/mobile/themes/default/goods.dwt";i:1;s:67:"D:/xampp/htdocs/e2828/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1471592381;s:8:"maketime";i:1471588781;}<!DOCTYPE html>
...
<title>OPPO R9 Plus(全网通)_oppo_手机专区_汕头E家数码-汕头手机报价网|汕头手机网|汕头手机门户网站 - Powered by ECShop触屏版</title>
...
function chgNum(a) {
    ...
    if (a == 1) {
      ...
      <div class="show">
        ...
        <div class="flexslider">
          <ul class="slides">
            ...
            <li ><img src="../images/201606/goods_img/59_P_1464827830745.jpg" /></li>
             
            <li style="display:none"><img src="../images/201606/goods_img/59_P_1464827830388.jpg" /></li>
             
            <li style="display:none"><img src="../images/201606/goods_img/59_P_1464827830157.jpg" /></li>
                      </ul>
        </div>
      </div>
      ...
      <div class="pro-info">
        <p class="pro-name"><strong>OPPO R9 Plus(全网通)</strong></br>
          </p>
        <div class="price clearfix">
          <p class="jx-price">售价&nbsp;&nbsp;&nbsp;<strong>￥0.10</strong></p>
          <p class="market-price"><strong>￥0.11</strong></p>
        </div>
		        <div class="brand clearfix">
          <p class="name">品牌</p>
          <p class="detial"><a href="brand.php?id=11" >oppo</a></p>
        </div>
		
		<div class='goods_number clearfix'>
          <p class="name">人气</p>
          <span id="msg">238 </span>
		</div>
		<style>
        ...
        <form action="javascript:addToCart(59)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          ...
          <p class="name">规格</p>
          <div class="catt">
						<a class="cattsel" onclick="changeAtt(this,312,59)"
			href="javascript:;" name="312">行货 金色(64G)<input style="display:none"
			id="spec_value_312" type="radio" name="spec_8" value="312" 			checked /></a>
						<a  onclick="changeAtt(this,1862,59)"
			href="javascript:;" name="1862">行货 玫瑰金(64G)<input style="display:none"
			id="spec_value_1862" type="radio" name="spec_8" value="1862"  /></a>
						</div>
		</div>
      ...
      <div class="pro-detial">
        <div class="judge clearfix"> <a href="goods.php?act=view_comment&id=59"><span class="m-ratescore"><i style="WIDTH: 100%">100%</i></span> <span class="all"><strong>554fcae493e564ee0dc75bdf2ebf94cagoods_comment|a:2:{s:4:"name";s:13:"goods_comment";s:2:"id";s:2:"59";}554fcae493e564ee0dc75bdf2ebf94ca</strong>人评论</span> <span class="nice"><strong>100%</strong>好评</span></a> <span class="arrow"></span> </div>
        <div class="pro-intro clearfix"> <a href="goods.php?act=view_img&id=59"><span>商品详细介绍</span></a> <span class="arrow"></span> </div>
      </div>
...
<script language="javascript">
$('#pc_nav').attr('href', './../goods.php?id=59');
</script>
</body>
</html>
