...
?>
        <div class="hd-show-item <?php if ($this->_foreach['index_image']['iteration'] == 1): ?>hd-show-item-first<?php endif; ?>"> <a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank"><img alt="3" src="<?php echo $this->_var['ad']['image']; ?>" /></a> </div>
	  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
...
?>
           <!-- <div class="xm-star-goods-item">
              <div class="item-content"> <span class="item-thumb"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['short_name']); ?>" /></a> </span> <span class="item-title"><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></span> <span class="item-desc"><?php echo htmlspecialchars($this->_var['goods']['brief']); ?></span> </div>
            </div>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
	  <?php if ($this->_foreach['index_image']['iteration'] == 1): ?>
                  <div class="item-content"> <a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank"> <span class="item-thumb"> <img src="<?php echo $this->_var['ad']['image']; ?>" alt="<?php echo $this->_var['ad']['name']; ?>" /> </span> </a> </div>
				  <?php endif; ?>	
	  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </div>
              </div>
...
?>
				<?php if ($this->_foreach['new_goods']['iteration'] == 1): ?>
                  <div class="item-content"> <span class="item-info"> <span class="item-title"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></span> <span class="item-price"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></span> </span> <span class="item-thumb"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" ><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:220px" /></a> </span> </div>
				<?php endif; ?>	
		   		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		        </div>
              </div>
...
?>
				<?php if ($this->_foreach['new_goods']['iteration'] == 2): ?>
                    <div class="item-content"> <span class="item-info"> <span class="item-title"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></span> <span class="item-price"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></span> </span> <span class="item-thumb"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:135px" /></a> </span> </div>
					<?php endif; ?>	
		   <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                  </div>
                </div>
...
?>
				<?php if ($this->_foreach['new_goods']['iteration'] == 1): ?>
                  <div class="item-content"> <span class="item-info"> <span class="item-title"><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></span> <span class="item-price"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></span> </span> <span class="item-thumb"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:220px" /></a> </span> </div>
				<?php endif; ?>	
		   		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		        </div>
              </div>
...
if ($this->_foreach['new_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['new_goods']['iteration']++;
?>
                <li <?php if ($this->_foreach['new_goods']['iteration'] < 4): ?>class="top"<?php endif; ?>> <span class="item-info"> <span class="item-title"><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></span> <span class="item-price"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></span> </span> <span class="item-thumb"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:70px" /></a> </span> <span class="item-num"><?php echo $this->_foreach['new_goods']['iteration']; ?></span> </li>
			  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
...
?>
		<?php if ($this->_foreach['message_lists']['iteration'] < 5): ?> 
            <div class="xm-commented-goods-item J_commentedGoods">
              <div class="item-content"> <span class="item-info"> <span class="item-title"><a href="goods.php?id=<?php echo $this->_var['msg']['goods_id']; ?>"><?php echo $this->_var['msg']['goods_name']; ?></a></span> <span class="item-meta"><span class="icon-stat icon-stat-5"></span></span> <span class="item-price"><?php echo $this->_var['msg']['shop_price']; ?></span> </span> <span class="item-thumb"> <a href="goods.php?id=<?php echo $this->_var['msg']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['msg']['goods_thumb']; ?>" style="width:220px; height:220px" alt="<?php echo $this->_var['msg']['goods_name']; ?>" /></a> </span> <span class="item-comment"><?php echo sub_str($this->_var['msg']['content'],20); ?></span> </div>
            </div>
		<?php endif; ?>
		  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 	
