<div class="viewport">
			<div id="footer" class="footer">
				...
				<div class="row g_3">
				<?php $_from = get_advlist_by_id(5); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_18200000_1471400614');$this->_foreach['index_ad'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_ad']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_18200000_1471400614']):
        $this->_foreach['index_ad']['iteration']++;
?>
					<p><?php echo $this->_var['ad_0_18200000_1471400614']['ad_code']; ?></p>
