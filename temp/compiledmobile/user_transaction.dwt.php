...
?>
	...
	<!--	<tr>
		...
		<tr>
		 ...
		 <?php echo $this->_var['lang']['passwd_answer']; ?>"   name="passwd_answer" type="text" size="25" class="inputBg" maxlengt='20' value="<?php echo $this->_var['profile']['passwd_answer']; ?>"/><!-- <?php if ($this->_var['field']['is_need']): ?> <?php endif; ?>		  </td>
	<!--	</tr>
		<?php else: ?>
	<!--	<tr>
		 
	<?php if ($this->_var['field']['is_need']): ?>id="extend_field<?php echo $this->_var['field']['id']; ?>i"<?php endif; ?>>
		<?php echo $this->_var['field']['reg_field_name']; ?>"  name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" class="inputBg" value="<?php echo $this->_var['field']['content']; ?>"/><!-- <?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>			</td>
	<!--	</tr>
		<?php endif; ?>
	<!--	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <tr>
	...
	-->
	 ...
	 <tr>
          ...
          <td colspan="2"  align="left" ><input  placeholder="用户名" name="uid" type="text" size="25"  class="inputBg" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2"  align="left" ><input placeholder="<?php echo $this->_var['lang']['confirm_password']; ?>" name="confirm_password" type="password" size="25"  class="inputBg" /></td>
        </tr>
        <tr>
...
?>
	...
	function a()
     {
        var divD = document.getElementById("address");
       if(divD.style.display=="none")
      {
       ...
       else
         {
            ...
            <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee');$this->_foreach['pp'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['pp']['total'] > 0):
    foreach ($_from AS $this->_var['sn'] => $this->_var['consignee']):
        $this->_foreach['pp']['iteration']++;
?>
	
	<?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['tel']): ?>
		     <script type="text/javascript">
	function b_<?php echo $this->_var['sn']; ?>()
     {
        var divD = document.getElementById("pp_<?php echo $this->_var['sn']; ?>");
		var divD1 = document.getElementById("vv_<?php echo $this->_var['sn']; ?>");
       if(divD.style.display=="none")
      {   
       ...
       else
         {
			...
			<div  id="vv_<?php echo $this->_var['sn']; ?>" style="display:inline" class="header_One"> 
			
			<div id="consignee_<?php echo $this->_var['sn']; ?>" class="header_Three" style="display:inline;"><?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?></div>
				<div id="address_<?php echo $this->_var['sn']; ?>" class="header_Four" style="display:inline;"> <?php echo htmlspecialchars($this->_var['consignee']['address']); ?></div>
				<div id="tel_<?php echo $this->_var['sn']; ?>" class="header_Five" style="display:inline;"> <?php echo htmlspecialchars($this->_var['consignee']['tel']); ?></div>
			    <div classs="header_Two" style="display:inline;">
					  <a>
...
?>
					  <?php if ($this->_var['consignee']['province'] == $this->_var['province']['region_id']): ?>
...
?>
					  <?php if ($this->_var['consignee']['city'] == $this->_var['city']['region_id']): ?>
                        <?php echo $this->_var['city']['region_name']; ?>
					  <?php endif; ?>
                      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </a>
					 <a>
...
?>
					  <?php if ($this->_var['consignee']['district'] == $this->_var['district']['region_id']): ?>
                        <?php echo $this->_var['district']['region_name']; ?>
					  <?php endif; ?>
                      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </a>
            ...
            <form action="user.php" method="post" name="theForm" onsubmit="return checkConsignee(this)" style="padding-bottom:20px;">
	     	...
	     	<div id="pp_<?php echo $this->_var['sn']; ?>" style="display:none" >
              <table width="100%" border="0" cellpadding="5" cellspacing="1" >
                <tr>
...
?>
             ...
             <!--   <tr>
              ...
              <td align="left" ><input placeholder="<?php echo $this->_var['lang']['backup_phone']; ?>" name="mobile" type="text" class="inputBg" id="mobile_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?>" /></td>
                ...
                <tr>
                  ...
                  <td align="center"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['tel']): ?>
			...
			<div class="header_a"><a href="javascript:;" onClick="b_<?php echo $this->_var['sn']; ?>()"  >编辑</a></div>
	     <?php else: ?>
...
?>
		 ...
		 <div class="header_a" style="width:70px"> <a href="javascript:;" onClick="a()"  >添加新地址</a> </div>
