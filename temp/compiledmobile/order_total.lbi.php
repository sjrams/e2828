...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="" style="padding-right:10px">
  <?php if ($_SESSION['user_id'] > 0 && ( $this->_var['config']['use_integral'] || $this->_var['config']['use_bonus'] )): ?>
  <tr>
    <td align="right" bgcolor=""  style="padding-right:10px">
  ...
  <?php endif; ?>
  <tr>
    <td align="right" bgcolor=""  style="padding-right:10px"> <?php echo $this->_var['lang']['total_fee']; ?>: <font class="f4_b"><?php echo $this->_var['total']['amount_formated']; ?></font>
