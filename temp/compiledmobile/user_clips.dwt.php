...
function get(obj) {
    ...
    obj.disabled = true;
	 ...
	 url:'qd.php',
    type:'post',
	data:"Tel="+"<?php echo $this->_var['info']['username']; ?>",
...
<div class="login">
		...
		<div><img  src="http://www.e2828.cn/e2828/images/hyk.png"  width="100%" hei style="vertical-align:bottom;></div>
        <section style="width:100%;margin:5px auto 0;overflow:hidden; background-color:#F4F4F4">
		  <div class="user" id="qwe">
			...
			<div class="info" id="qwe">
			  ...
			  <tr style="height:30px;"><td> 
                            <form action=""  >
			  <input id="Button1"  type="submit" value="签到" onClick="get(this)" style="width:50px;height:30px;"  size="10"/>
			   积分：<strong id="day"><?php echo $this->_var['info']['integral']; ?></strong>
			  </form>
                          </strong></td>
			...
			<div class="account order">
			  ...
			  <ul>
				...
				<li> <a href="/../e2828/exchange.php">积分商城</a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
  ...
  <?php echo $this->smarty_insert_scripts(array('files'=>'transport.js,utils.js')); ?>
    ...
    <div class="blank"></div>
     ...
     <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
      <tr align="center">
        <th width="36%" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_name']; ?></th>
